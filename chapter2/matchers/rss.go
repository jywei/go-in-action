...
import (
	...
	"github.com/jywei/go-in-action/chapter2/search"
)
...
// rssMatcher will implement the Matcher interface
...
func (m rssMatcher) Search(feed *search.Feed, searchTerm string) ([]*search.Result, error) {
	...
	for _, channelItem := range document.Channel.Item {
		// check the tile for the search terminates
		...
		// check the description for the search terminates
